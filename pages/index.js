...
help you Support businesses with massive ROI</span>
  ...
  <div class="grid grid-cols-1 md:grid-flow-col w-full md:grid-cols-2 lg:grid-cols-4 gap-5 mt-5 mb-2 rounded-20 md:ml-2  md:flex justify-center content-start">    
    ...
    <div class="rounded-xl shadow-lg bg-white md:w-max  flex justify-center ">
      ...
      <h5 class="text-2xl md:text-2xl font-sans text-[#009A9A] font-bold text-center mt-4">Loli Creations</h5>
      </div>
      <p class="text-black-500 font-mono xl-text-l md:text-m font-bold lg:text-base mt-3">Loli began out of a love for creating beautiful pieces of handmade accessories. 
...
<div class="rounded-xl shadow-lg bg-white  ">
      ...
      <div class="flex items-center">
      <h5 class="text-2xl md:text-2xl font-sans text-[#009A9A] font-bold text-center mt-">IrriFarm</h5>
      </div>
...
<div class="rounded-xl shadow-lg bg-white  ">
      ...
      <div class="flex items-center">
      <h5 class="text-2xl md:text-2xl font-sans font-bold text-[#009A9A] text-center mt-4">Usafi Sanitation</h5>
      </div>
...
<div class="rounded-xl shadow-lg bg-white  ">
      ...
      <h5 class="text-2xl md:text-2xl text-[#009A9A] font-sans font-bold mt-4">ScanPaY </h5>
    
      <p class="text-black-500 lg:text-base xl-text-l md:text-base font-bold font-mono mt-3">ScanPay allows you to invest in Africa and Growth Markets using Blockchain platform and infrastructure to allow crowdfunding and enable African Diaspora in funding development.

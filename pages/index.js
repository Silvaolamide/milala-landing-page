...
export default function Home() {
  return (
    ...
    <header className="pt-9">
      ...
      <div  className="flex  w-10/12    border-red-400 justify-center mx-auto item-center tracking-tighter"> 
          <div className="flex flex-col w-5/12">
            ...
            <div className="flex text-[102px] font-roboto font-extra-bold ">
...
help you invest in businesses with massive ROI </p>
              ...
              <div className="flex bg-black-400 border-t-zinc-600 bg-black  justify-between  border-red-400  mx-auto item-center tracking-tighter"> 
                ...
                <div className="flex  flex-col h-[80px] items-center text-[#7da7a7] text-sm">
                    
                  
                    <p>(c) Milala 2022. All Rights  Reserved</p>

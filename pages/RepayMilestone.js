...
<DashBoard class="" >
    ...
    <h1 class="font-bold text-2xl itaems-center text-black text-center justify-center mt-3 py-12">Repay Milestone</h1>
    ...
    <div class="-my-8 divide-y-2 divide-gray-100">
      <div class="py-8 flex flex-wrap md:flex-nowrap">
        ...
        <div class="md:flex-grow">
          ...
          <Link href="#" class="text-teal-900 inline-flex items-center font-bold mt-4">Repay Milestone
